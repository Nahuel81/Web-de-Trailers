...
package com.pelicula.trailers.controllers;

import com.pelicula.trailers.entity.Categoria;
import com.pelicula.trailers.entity.Pelicula;
import com.pelicula.trailers.repository.CategoriaRepository;
import com.pelicula.trailers.repository.PeliculaRepository;
import com.pelicula.trailers.service.AlmacenServiceImpl;
...
public class AdminController {
   ...
   @Autowired
	...
	@Autowired
	private CategoriaRepository generoRepositorio;
	...
	public ModelAndView mostrarFormularioDeNuevaPelicula() {
		List<Categoria> generos = generoRepositorio.findAll(Sort.by("titulo"));
